...
TEST_P(IskhakovDLinearTopologyFuncTests, MatmulFromPic) {
...
const auto kTestTasksList =
    std::tuple_cat(ppc::util::AddFuncTask<IskhakovDLinearTopologyMPI, InType>(kTestParam, PPC_SETTINGS_iskhakov_d_linear_topology),
...
INSTANTIATE_TEST_SUITE_P(PicMatrixTests, IskhakovDLinearTopologyFuncTests, kGtestValues, kPerfTestName);
